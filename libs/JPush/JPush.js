...
exports.buildClient = function (appKey, masterSecret, retryTimes, isDebug, readTimeOut, proxy) {
  if (arguments.length === 1 && typeof arguments[0] === 'object') {
    ...
    return new JPushClient(appKey, masterSecret, retryTimes, isDebug, readTimeOut, proxy)
  }
}

// function JPushClient (appKey, masterSecret, retryTimes, isDebug, readTimeOut = null, proxy = null) {
function JPushClient (appKey, masterSecret, retryTimes, isDebug, readTimeOut, proxy) {
...
function _request (client, url, body, method, callback, times) {
  if (client.isDebug) {
    debug('Push URL :' + url)
    if (body) {
      debug('Body :' + body)
